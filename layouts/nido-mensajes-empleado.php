<?php
    ...
    $empleado = wp_get_current_user();
    list( $cuido_id, $empleado_id ) = preg_split( '/,/', get_user_meta( $empleado->ID, 'description', true ) );
    ...
    $conversaciones_activas_ordenadas = $wpdb->get_results("
        ...
        WHERE 1=1 
            AND (($wpdb->postmeta.meta_key = 'wpcf-para-mensajes' AND $wpdb->postmeta.meta_value = '$empleado_id')) 
...
<div id="nido-mensajes" class="nido-mensajes">
    ...
    ?>
            ...
            <li>
                ...
                <i class="fa fa-trash-o nido-trash" aria-hidden="true"></i>
            </li>
...
<div class="nido-enviar-mensaje-wrapper">
    ...
    <div class="nido-enviar-mensaje" style="display: none">
        ...
        <div class="nido-message-uploads"><img class="nido-flaggear" src="<?php echo get_template_directory_uri() ?>_child/assets/icons/flag-outline-e1500048496501.png"><img class="nido-adjuntar" src="<?php echo get_template_directory_uri() ?>_child/assets/icons/nido-documentos-mensajes.png"><img style="display: none" class="nido-loading" src="<?php echo get_site_url() ?>/wp-content/plugins/formidable/images/ajax_loader.gif"></div>
    </div>
</div>
