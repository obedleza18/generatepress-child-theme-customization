<?php
    ...
    $cuido_id = get_user_meta( $cuido->ID, 'description', true );
    ...
    $conversaciones_activas_ordenadas = $wpdb->get_results("
        ...
        WHERE 1=1 
            AND (($wpdb->postmeta.meta_key = 'wpcf-para-mensajes' AND $wpdb->postmeta.meta_value = '$cuido_id')) 
